...
package cat.mey.platform.api.auth.routes.sessions

import cat.mey.platform.api.auth.routes.sessions.data.types.responses.ListSessionsResponseBody
...
fun Route.sessionsRoutes() {
    route("/sessions") {
        ...
        get("/all") {
            ...
            call.respond(HttpStatusCode.OK, ListSessionsResponseBody.Success(
