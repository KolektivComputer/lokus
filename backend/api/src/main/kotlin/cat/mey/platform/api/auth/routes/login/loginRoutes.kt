...
package cat.mey.platform.api.auth.routes.login

import cat.mey.platform.api.auth.routes.login.data.types.requests.LoginRequestBody
import cat.mey.platform.api.auth.routes.login.data.types.responses.LoginResponseBody
