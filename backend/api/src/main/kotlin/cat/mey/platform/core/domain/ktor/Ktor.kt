...
package cat.mey.platform.core.domain.ktor

import cat.mey.platform.core.auth.jobs.DeactivateSessionsJob.Companion.getKoin
...
inline fun <reified T : Any> ApplicationCall.getDomainScoped(): T =
    domainScope.get()
