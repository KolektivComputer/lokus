...
import cat.mey.platform.core.auth.data.types.session.results.DeleteSessionResult
...
class SessionService : KoinComponent {
    ...
    suspend fun getAccountSessionsSuspend(activeSession: ActiveSession) = getAccountSessionsSuspend(activeSession.accountId)
}