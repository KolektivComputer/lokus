package capital.yuri.locus.platform.api.auth.routes.password.data.types.responses
...
sealed interface ResetPasswordResponseBody : ApiResult {
    ...
    abstract class Failure :
        ...
        class RequestExpired private constructor() : Failure() {
            ...
            companion object {
                operator fun invoke(expiredAt: Instant): RequestExpired = RequestExpired().apply {
